...
app.add_argument("-b", "--batch-size", type = int, default = 32,
                help = "batch size of images to be passed through the network")
app.add_argument("-s", "--buffer-size", type = int, default = 1000, 
...
#shuffle them to allow for easy training and testing splits via array
#slicing during training time
...
#initializing the HDF5 datasetwriter, then store the class label 
...
for i in np.arange(0, len(imagePaths), bs):
  ...
  #list of actual images that will be passed through the network for feature
  #feature extraction 
  ...
  #add the features and the labels to our HDF5 dataset
